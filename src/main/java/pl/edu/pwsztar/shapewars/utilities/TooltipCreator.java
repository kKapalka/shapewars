...
//
//    private static final List<SkillStatusEffect> THREE_TURN_EFFECTS=Arrays.asList(
...
//    );
//    private static final List<SkillStatusEffect> BENEFICIAL=Arrays.asList(
//            SkillStatusEffect.ARMOR_PLUS,
//            SkillStatusEffect.SPEED_PLUS,
//            SkillStatusEffect.STRENGTH_PLUS
//    );
//    private static final List<SkillStatusEffect> HARMFUL=Arrays.asList(
//            SkillStatusEffect.ARMOR_MINUS,
//            SkillStatusEffect.SPEED_MINUS,
//            SkillStatusEffect.STRENGTH_MINUS
//    );
...
//    );
//    private static final List<SkillStatusEffect> TURN_BASED_EFFECTS=Arrays.asList(
